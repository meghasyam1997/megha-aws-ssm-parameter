parameters = [
  ...
  { name = "dev.catalogue.mongodb.endpoint", value = "mongodb-dev.msdevops72.online" },
  { name = "dev.shipping.mysql.endpoint", value = "mysql-dev.msdevops72.online" },
  { name = "dev.shipping.mysql.user", value = "root" },
